                ...
                JPanel panel = new JPanel() {
                        protected void paintComponent(Graphics g) {
                                ...
                                for (int i = 0; i < 11; i++) {         
                                        ...
                                        Ellipse2D.Float circle = new Ellipse2D.Float(x - 4.0f,y - 4.0f, 10.0f, 10.0f);
                                        System.out.println("Punkt nr " + i + ": " +(x-4.0f) + " " + (y-4.0f) +" ");
                                        ...
                                        if (i == 10) {
                                                ...
                                                //posrednie kropki sciezki
                                                        ...
                                                        if(i>0){
                                                                ...
                                                                QuadCurve2D quadcurve = new QuadCurve2D.Float(x_begin,y_begin, x_begin+20.0f, y, x, y);
                                                                g2d.draw(quadcurve);
                                                                //path.lineTo(x, y);
